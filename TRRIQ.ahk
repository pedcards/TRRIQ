...
;	Make sure we are on Patient Summary / Contacts, either inpatient or outpatient
	...
	relStr := "Father|Mother|Grandmother|Grandfather|Aunt|Uncle|Relative|Step|Sibling|Adult"
	rel := Object()
...
*/
	...
	if (monType~="PR|ZIO") {
		...
		tabs := "dem-Name_L	dem-Name_F	dem-MRN	dem-DOB	dem-Sex(NA)	dem-Ordering	dem-Site	dem-Billing	dem-Device_SN	"
