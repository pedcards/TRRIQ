...
BuildRTF() {
	...
	rtf := "{\E\rtf1\E\ansi\E\deff0\E\nouicompat{\E\fonttbl{\E\f0\E\fnil\E\fcharset0 Segoe UI;}}\E\viewkind4\E\uc1 "
		 ...
		 . "\E\b TEST INFORMATION\E\b0\E\par "
		 . "Test Date(s): " fldval["dem-Test_date"] strQ(fldval["dem-Test_end"]," - ###") "\E\par "
		 . "Ordering Provider: "  "\E\par "
		 . "Interpreting Provider: "  "\E\par "
		 . "Indication(s) for Holter Monitoring:\E\par "  "\E\par\E\par "
		 ...
		 . "\E\row"
			...
			. "\E\intbl "  "\E\cell"
		 . "\E\row"
			. "\E\intbl Avg HR\E\cell"
			. "\E\intbl "  "\E\cell"
		 . "\E\row"
			. "\E\intbl Total QRS\E\cell"
			. "\E\intbl "  "\E\cell"
		 . "\E\row }"
		 . "\E\par "
		 . "{\E\trowd\E\cellx2000\E\cellx4000\E\cellx6000\E\cellx8000"
			. "\E\intbl Total VE Beats\E\cell"
			. "\E\intbl 24 (0%)\E\cell"
			. "\E\intbl Total SVE Beats\E\cell"
			. "\E\intbl 4 (0%)\E\cell"
		 . "\E\row"
			. "\E\intbl Vent Runs\E\cell"
			. "\E\intbl 24 (0%)\E\cell"
			. "\E\intbl Total SVE Runs\E\cell"
			. "\E\intbl 4 (0%)\E\cell"
		 . "\E\row"
			. "\E\intbl Beats\E\cell"
			. "\E\intbl 24 (0%)\E\cell"
			. "\E\intbl Beats\E\cell"
			. "\E\intbl 4 (0%)\E\cell"
		 . "\E\row"
		 ...
		 . "\E\row"
			...
			. "\E\intbl 4 (0%)\E\cell"
		 . "\E\row"
			. "\E\intbl Triplets\E\cell"
			. "\E\intbl 24 (0%)\E\cell"
			. "\E\intbl Atrial Pairs\E\cell"
			. "\E\intbl 4 (0%)\E\cell"
		 . "\E\row"
			. "\E\intbl Couplets\E\cell"
			. "\E\intbl 24 (0%)\E\cell"
			. "\E\intbl Drop/Late\E\cell"
			. "\E\intbl 4 (0%)\E\cell"
		 . "\E\row"
			. "\E\intbl Single/Interp VEs\E\cell"
			. "\E\intbl 24 (0%)\E\cell"
			. "\E\intbl Longest R-R\E\cell"
			. "\E\intbl 4 (0%)\E\cell"
		 . "\E\row"
			. "\E\intbl R-on-T\E\cell"
			. "\E\intbl 24 (0%)\E\cell"
			. "\E\intbl Single PACs\E\cell"
			. "\E\intbl 4 (0%)\E\cell"
		 . "\E\row"
			. "\E\intbl Single/Late VEs\E\cell"
			. "\E\intbl 24 (0%)\E\cell"
			. "\E\intbl Pauses\E\cell"
			. "\E\intbl 4 (0%)\E\cell"
		 . "\E\row"
			. "\E\intbl Bi/Trigeminy\E\cell"
			. "\E\intbl 24 (0%)\E\cell"
			. "\E\intbl Bi/Trigeminy\E\cell"
			. "\E\intbl 4 (0%)\E\cell"
		 . "\E\row }"
...
*/
	...
	if InStr(txt,"MORTARA") {															; Mortara Holter
		...
		res.mrn := t1
		res.date := parseDate(stRegX(txt,"Full Disclosure Report\R+",1,1,"-",1)).YMD
		q := findWQid(res.date,res.mrn)
		k := readWQ(q.id)
		if IsObject(k) {
			name := parseName(k.Name)
		} else {
			name := parseName(Trim(stRegX(txt,"Patient:",1,1,"\/",1)))
		}
		res.nameL := name.last
		res.nameF := name.first
